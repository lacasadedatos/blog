...
::: {.infobox data-latex="warning"}
> ⛏️ ¿Podemos explotar de alguna manera estos patrones de agrupación y obtener un criterio de selección? ¿Podemos explotar de alguna manera estos patrones de agrupación y obtener un criterio de selección?
:::
...
::: {.infobox data-latex="warning"}
> 🥳️ El análisis de agrupación por k-medias nos ha permitido identificar claramente un grupo de países con las peores variables sociodemográficas.... Pero... ¿podríamos haber usado simplemente los valores de PIB más bajos como filtro? 🤔
:::
